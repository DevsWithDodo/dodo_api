...
return [
    ...
    'password'             => 'A megadott jelszó nem egyezik meg a várt értékkel!',
    ...
    */
    ...
    'attributes' => [
        ...
        'currency' => 'pénznem',
        'default_currency' => 'pénznem',
        'nickname' => 'becenév',
        'member_nickname' => 'becenév',
        'invitation_token' => 'meghívó',
        'amount' => 'összeg',
        'note' => 'megjegyzés',
        'reaction' => 'reakció',
        'password_reminder' => 'jelszóemlékeztető',
        'language' => 'nyelv',
